...
python _archive/ragie/upload_ap1_curated_summaries_to_ragie.py
```

Dry run (no API calls):

```powershell
python _archive/ragie/upload_ap1_curated_summaries_to_ragie.py --dry-run
```
...
2. Upload **only** the files in:
   ...
   `_archive/ragie/retrieval_summaries_bundle/summaries/*.summary.md`
...
2. Regenerate or edit `_archive/ragie/retrieval_summaries_bundle/summaries/{id}.summary.md` using `SUMMARY_GENERATION_INSTRUCTIONS.md`.
